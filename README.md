...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/evojax-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15442&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/evojax-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `evojax` can be installed with:

```
conda install evojax
```

It is possible to list all of the versions of `evojax` available on your platform with:
